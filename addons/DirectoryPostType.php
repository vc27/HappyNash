 ...
 * @updated 00.00.00
 **/
$DirectoryPostType = new DirectoryPostType();
class DirectoryPostType {
	...
	function register_post_type() {
		...
		$this->registered = register__post_type( array(
			'post_type' => array(
				'labels' => array(
					'name' => __( 'Directory', 'childtheme' ),
					'singular_name' => __( 'Directory', 'childtheme' ),
					'add_new' => __( 'Add New', 'childtheme' ),
					'add_new_item' => __( 'Add New', 'childtheme' ),
					'edit_item' => __( 'Edit Directory', 'childtheme' ),
					'new_item' => __( 'New Directory', 'childtheme' ),
					'view_item' => __( 'View Directory', 'childtheme' ),
					'search_items' => __( 'Search Directory', 'childtheme' ),
					'not_found' => __( 'No Directory found', 'childtheme' ),
					'not_found_in_trash' => __( 'No Directory found in Trash', 'childtheme' ), 
					'parent_item_colon' => '',
					'menu_name' => __( 'Directory', 'childtheme' )
				),
				...
				// 'menu_position' => null,
				// 'menu_icon' => get_stylesheet_directory_uri() . "/addons/PostTypes/images/directory-16x16.png", // is set in class construct
				...
				'query_var' => 'directory', // This goes to the WP_Query schema
				'can_export' => true,
